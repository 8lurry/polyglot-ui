...
+============================+====================================================================+===============+
| ``helptexts``              | Filter help_texts.py by checking Python object accessibility      | Required      |
+----------------------------+--------------------------------------------------------------------+---------------+
| ``modules``                | Filter .po entries by checking occurrence vs sys.modules          | Required      |
+----------------------------+--------------------------------------------------------------------+---------------+
| ``html``                   | Extract all untranslated .po entries from HTML sources            | No            |
+----------------------------+--------------------------------------------------------------------+---------------+
| ``translate``              | Translate using Gemini API                                         | No            |
+----------------------------+--------------------------------------------------------------------+---------------+
| ``update``                 | Update .po with translations and compile to .mo                    | No            |
+----------------------------+--------------------------------------------------------------------+---------------+
...
4. Checks if module is in ``sys.modules``
5. Only includes strings from imported modules

**Requires Django context**::
...
2. **Module strings** (``modules``):
   ...
   - Checks if module is in ``sys.modules``
   - Only includes strings from imported modules
...
- ``modules`` - needs ``sys.modules`` to check module imports
